...
class HrApprovedOvertime(models.Model):
    _name = "hr.approved.overtime"

    employee_id = fields.Many2one('hr.employee','Employee')
    manager_id = fields.Many2one('hr.employee','Manager')
    total_actual_hours =  fields.Float("Total overtime Hours")
    total_approved_hours = fields.Float("Total Approved overtime Hours")
